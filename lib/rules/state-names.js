...
const stateNodeDeclaration = (prefix) =>
  `${prefix}Property[key.name="states"] > ObjectExpression > Property`
const targetDeclaration = (prefix) =>
  `${prefix}Property[key.name="states"] Property[key.name="target"][value.type="Literal"]`
const targetArrayStringDeclaration = (prefix) =>
  `${prefix}Property[key.name="states"] Property[key.name="target"][value.type="ArrayExpression"] > ArrayExpression > Literal`
const simpleEventTargetDeclaration = (prefix) =>
  `${prefix}Property[key.name="on"] > ObjectExpression > Property[value.type="Literal"]`
const simpleOnDoneOnErrorTargetDeclaration = (prefix) =>
  `${prefix}Property:matches([key.name="onDone"], [key.name="onError"])[value.type="Literal"]`
...
module.exports = {
  ...
  create: function (context) {
    ...
    return {
      [stateNodeDeclaration(prefix)]: function (node) {
        if (node.computed) {
          return
        }
        const name =
      ...
      [targetDeclaration(prefix)]: validateTarget,
      [simpleEventTargetDeclaration(prefix)]: validateTarget,
      [simpleOnDoneOnErrorTargetDeclaration(prefix)]: validateTarget,
      [targetArrayStringDeclaration(prefix)]: validateTargetLiteral,
    }
  },
}
