...
module.exports = {
  ...
  create: function (context) {
    ...
    return {
      ...
      'Property[key.name="invoke"] > ObjectExpression > Property[key.name="src"]': checkServiceSrc,
      'Property[key.name="invoke"] > ArrayExpression > ObjectExpression > Property[key.name="src"]': checkServiceSrc,
