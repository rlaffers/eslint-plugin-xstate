...
const propertyOfChoosableActionObject = (prefix) =>
  `${prefix}CallExpression[callee.name="choose"] > ArrayExpression > ObjectExpression > Property`
const chooseFunctionCall = (prefix) =>
  `${prefix}CallExpression[callee.name="choose"]`
...
module.exports = {
  ...
  create: function (context) {
    ...
    return {
      [propertyOfChoosableActionObject(prefix)]:
      ...
      [chooseFunctionCall(prefix)]: function checkChooseFirstArgument(node) {
